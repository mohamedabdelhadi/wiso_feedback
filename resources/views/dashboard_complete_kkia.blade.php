                                ...
                                <div class="dp-main-menu pfl-txt2">
                                  <div class="user-profile-section">
                                    <div class="media">
                                        ...
                                        @else
                                            <script>window.location = "https://qltyss.com/kkia_dashboard/";</script>
                                        @endif
                                        </div>
                                    </div>
                                  </div>

                                  <a href="https://qltyss.com/kkia_dashboard/logout" class="dropdown-item  fd"><i class="fa fa-sign-out"></i> Logout</a>
