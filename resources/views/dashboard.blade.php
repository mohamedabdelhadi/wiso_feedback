  ...
  <head>
    ...
    <style> 
           ...
           .bg-shadows {
            ...
            box-shadow: 5px 5px 10px rgba(0,0,0, 0.5); /* Apply a box shadow */
        ...
        .revert-transform {
            transform: translateY(0); /* Revert to original position */
            transition: opacity 0.9s, transform 0.9s;
        }
                                ...
                                <div class="dp-main-menu pfl-txt2">
                                  <div class="user-profile-section">
                                    <div class="media">
                                        ...
                                        @else
                                            <script>window.location = "http://localhost:8080/kkia_dashboard";</script>
                                        @endif
                                        </div>
                                    </div>
                                  </div>

                                  <a href="http://localhost:8080/kkia_dashboard/logout" class="dropdown-item  fd"><i class="fa fa-sign-out"></i> Logout</a>
                  ...
                  <!-- ==========end header=========== -->
                    ...
                    <div class="modal-dialog modal-xl">
                        ...
                        <div class="modal-body" id="root">
                                ...
                                <!-- pdf section start -->
                                    <div class="row "   id="root2" >
                                        <hr>
                                        <div class="col-lg-12 col-sm-12 col-12 col-md-12 text-center py-5">
                                            <img src="{{url('frontend/img/kkia.png')}}" class="w-25" alt="">
                                           
                                        </div>
                                        <div class="col-lg-3 col-sm-12 col-md-4 col-xl-3 col-3  pdfSection p-4 stat chngsze border" >
                                            <ul  class="list-group">
                                                <li><img src="" alt="SelectedFrame " style="width:150px; height:150px; " id="SelctFrame"><span id="FrameInfo" class="fw-bold"></span></li>
                                        ...
                                        <div class="col-lg-7 col-sm-7 col-md-8 col-xl-7 col-sm-12 col-12 d-flex align-items-center border justify-content-center chngechrt">
                                        ...
                                        <p class="text-center"> Powered By <b>KKIA</b> :<span class="dtenw"><span></p>
                                    </div>
                            <!-- pdf section end -->
                  ...
                  <div class="content-wrapper togglesidebar main-content ">
                    <section class="dashboard-top-sec">
                      <div class="container-fluid" >
                                    ...
                                    <div class="col-lg-3 bg-control1 bg-shodows box ">
                                            <div class="row p-3 ">
                                                ...
                                                <div class="col-lg-2 col-sm-12 text-center ">
                                                    ...
                                                    <button class="btn btn-primary btn-sm getGenderbtn px-4 dshbtn mtpbm fw-bold" id="filter_count">Loading..</button>
                                    ...
                                    <div class="col-lg-3 bg-control2 bg-shodows box" >
                                            <div class="row p-3 ">
                                                ...
                                                <div class="col-lg-2 col-sm-12 text-center ">
                                                    ...
                                                    <button class="btn btn-primary btn-sm getGenderbtn text-white px-4 dshbtn mtpbm toggle-shadow" id="Male">Men</button>
                                                </div>
                                    ...
                                    <div class="col-lg-3 bg-control3 bg-shodows box">
                                            <div class="row p-3 ">
                                                ...
                                                <div class="col-lg-2 col-sm-12 text-center">
                                                    ...
                                                    <button class="btn bg-female text-white dshbtn btn-sm getGenderbtn px-4 mtpbm toggle-shadow" id="Female">Women</button>
                                                </div>
                                    ...
                                    <div class="col-lg-3 bg-control4 bg-shodows box bg-shadows">
                                            <div class="row p-3">
                                                ...
                                                <div class="col-lg-2 col-sm-12 text-center">
                                                    ...
                                                    <button class="btn bg-wm text-white btn-sm getGenderbtn px-4 myactive dshbtn mtpbm toggle-shadow " id="wmdata">Total</button>
                            ...
                            <div class="row " >
                              <div class="col-lg-3   bg-control "   style="height: 63vh !important;">
                                <div class="row" id="stastics "  style="height: 100%;">

                                    <div class="col-lg-12   box2 " >
                                        <div class="row p-1 " style="height: 100%;">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6 box2 bg-control text-center  d-flex flex-column justify-content-center align-items-center"   style="height: 100%;">
                                                <i class="fa fa-smile fa-happy  fa-3x p-2 rounded " aria-hidden="true"></i>
                                                <hr class="border w-100">
                                                <h6 class="pt-2  ">  Happy <span class="text-white  counter" id="Happy">0%</span></h6>
                                                
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6 box2 bg-control text-center  d-flex flex-column justify-content-center align-items-center"   style="height: 100%;">
                                                <i class="fa fa-frown fa-sad fa-3x p-2 rounded" aria-hidden="true"></i>
                                                <hr class="border w-100">
                                    ...
                                    <div class="col-lg-12  box2 " >
                                      <div class="row p-1 " style="height: 100%;">
                                          <div class="col-lg-6 col-md-6 col-sm-6 col-6 box2 bg-control text-center  d-flex flex-column justify-content-center align-items-center"   style="height: 100%;">
                                                <i class="fa fa-meh fa-neutral fa-3x p-2 rounded " aria-hidden="true"></i>
                                                <hr class="border w-100">
                                                <h6 class="pt-2  text-center">  Neutral  <span class="text-white  counter" id="Neutral">0%</span></h6>
                                               
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6 box2 bg-control text-center  d-flex flex-column justify-content-center align-items-center"   style="height: 100%;">
                                                <i class="fa fa-angry fa-angry fa-3x p-2 rounded" aria-hidden="true"></i>
                                                <hr class="border w-100">
                                    ...
                                    <div class="col-lg-12  box2 " >
                                      <div class="row p-1 " style="height: 100%;">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 box2 bg-control text-center  d-flex flex-column justify-content-center align-items-center"   style="height: 100%;">
                                                <i class="fa fa-surprise  fa-3x p-2 rounded" aria-hidden="true"></i>
                                                <hr class="border w-100">
                              ...
                              <div class="col-lg-6 bg-control chrtbx box"  style="height: 63vh !important; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                      <div class="row bg-control justify-content-center box3 p-3 flex-grow-1 box3" >
                                            ...
                                            <div class="col-lg-12">
                                                    <div class="row" >
                                                        <div class="col-lg-12  col-md-12 col-sm-12 col-12 pt-4 pb-5">
                                                            ...
                                                            <h5 class="text-white text-center pt-5 hide" id="nodataFound"> No Data Found !</h5> 
                                                          </div>
                             ...
                             <div class="col-lg-3 " style="height: 63vh !important; display: flex; flex-direction: column;">
                                            <div class="row bg-control justify-content-center box3 p-3 flex-grow-1">
                                            ...
                                            <div class="row bg-control box3 flex-grow-2">
                                                   <!-- Upload Frame start -->
                                                   <div class="col-lg-12">
                                            ...
                                            <div class="row bg-control justify-content-center box3 flex-grow-1"> 
