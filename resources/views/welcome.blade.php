                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 " style="background:#fff;">
                                <div class="row  d-flex justify-content-center ">
                                    ...
                                    <div class="col-lg-2 p-2">
                                        <h5 class="bg-kkia p-2  text-center text-white rounded">12K</h5>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-12 col-12">
                                        <canvas id="lineChart" class="vbg"></canvas>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mybox" style="background:#fff;">
                            <div class="row  ">
                                ...
                                <div class="col-lg-4  py-1  ">
                                    <h5 class="kkia_color text-end pt-3">08K </h5>
                                </div>
                                <div class="col-lg-12">
                                    <div class="row d-flex justify-content-center">
                                        
                                        <h5 class="text-white text-center pt-5 hide" id="nodataFound"> No data found in the response.</h5>
                                        {{-- <div class="col-lg-10 col-md-10 col-sm-12 col-12  py-5">
                                            <canvas id="lineChart" class="vbg"></canvas>
                                        </div> --}}
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mybox" style="background:#fff;">
                            <div class="row  ">
                                ...
                                <div class="col-lg-4  py-1  ">
                                    <h5 class="kkia_color text-end pt-3">12K </h5>
                                </div>
                                {{-- <div class="col-lg-12">
                                    <div class="row d-flex justify-content-center">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 box" >
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 p-4 mybox" style="background:#fff;">
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8 ">
                                    <h5 class="kkia_color">Lnaguage Usage</h5>
                                </div>
                                <div class="col-lg-4 text-end">
                                    <h5 class="kkia_color">123K</h5>
                                </div>
